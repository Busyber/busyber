...
import { HomeIcon,DeviceMobileIcon ,UserIcon, StarIcon, FastForwardIcon,ThumbUpIcon} from '@heroicons/react/solid';
...
function LandingScreen(props) {
    ...
    const [addBetaUserMutate, { data: addBetaUserData, error: addBetaUserError, loading: addBetaUserLoading }] = useMutation(gql`mutation($name : String, $email: String, $phone: String){
 addBetaUser(name : $name, email: $email, phone: $phone){ 
 name
email
phone
}}`
    ...
    return (
        <div className={" h-screen "}>
            <div className={"flex w-full align-start justify-start flex-col          "}>
                <LandingHeader
                    sideContent={<div className={"flex w-full align-start justify-start flex-col            p-16 "}>
                        <Form
                            onSubmit={() => executeAddBetaUserMutate()}
                        >
                            <div className={"flex w-full align-start justify-start flex-col          pb-2 pt-2 p-0 "}>
                                <FieldInput
                            ...
                            <div className={"flex w-full align-start justify-start flex-col            p-2 "}>
                                <Text
                                    className={" "}
                                    type={"text"}

                                >
                                    Do you want to be a tasker, customer or both?
                                </Text>

                            </div>
                            <div className={"flex w-full align-start justify-start flex-col        pr-0 pl-0 pb-10   "}>
                                <select
                                    //onChange={item =>}
                            ...
                            <SuccessAlert
                            tailwind={"mb-12"}
                                isShown={addBetaUserData}
                                title="Thank You!"
                                content="You have been added to the waitlist and will be notified as soon as we launch!"
                            />
                            <Button
                                className={"  w-full      "}
                                typeSubmit
                ...
                />
                <div id={'features'}
                    className={"flex w-full align-start justify-start flex-col           pt-10  "}>
                    <Features
